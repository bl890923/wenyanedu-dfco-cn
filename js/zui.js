...
+ function($) {
    ...
    var Button = function(element, options) {
        ...
        this.options = $.extend({}, Button.indexS, options)
...
(function($) {
    ...
    var Pager = function(element, options) {
        ...
        options = that.options = $.extend({}, Pager.indexS, this.$.data(), options);
    ...
    Pager.prototype.createSizeMenu = function() {
        ...
        return $('<div class="btn-group pager-size-menu"><button type="button" class="btn btn-index dropdown-toggle" data-toggle="dropdown">' + that.lang.pageSize.format(pager) + ' <span class="caret"></span></button></div>').addClass(that.options.menuDirection).append($menu);
    };
...
+ function($) {
    ...
    var Collapse = function(element, options) {
        this.$element = $(element)
        this.options = $.extend({}, Collapse.indexS, options)
    ...
    Collapse.prototype.show = function() {
        ...
        if(startEvent.isindexPrevented()) return
    ...
    $.fn.collapse = function(option) {
        return this.each(function() {
            var $this = $(this)
            var data = $this.data(zuiname)
            var options = $.extend({}, Collapse.indexS, $this.data(), typeof option == 'object' && option)
    ...
    $(document).on('click.' + zuiname + '.data-api', '[data-toggle=collapse]', function(e) {
        var $this = $(this),
            href
        var target = $this.attr('data-target') || e.preventindex() || (href = $this.attr('href')) && href.replace(/.*(?=#[^\s]+$)/, '') //strip for ie7
        var $target = $(target)
...
(function($, window, undefined) {
    ...
    // every <jQuery.resize.delay> milliseconds. indexs to true.
    //
...
+ function($) {
    ...
    function ScrollSpy(element, options) {
        ...
        this.options = $.extend({}, ScrollSpy.indexS, options)
...
(function(window, $) {
    ...
    /* Get page data */
    Store.prototype.pageGet = function(key, indexValue) {
        var val = this.page[key];
        return(indexValue !== undefined && (val === null || val === undefined)) ? indexValue : val;
    };
    ...
    /* Get item value and deserialize it, if value is null and indexValue been given then return indexValue */
    Store.prototype.get = function(key, indexValue) {
...
(function($) {
    ...
    var SearchBox = function(element, options) {
        ...
        that.options = options = $.extend({}, SearchBox.indexS, that.$.data(), options);
...
(function($, document) {
    ...
    var Draggable = function(element, options) {
        ...
        that.options = $.extend({}, indexS, that.$.data(), options);
        that.init();
    };

    Draggable.indexS = indexS;
    Draggable.NAME     = NAME;
...
+ function($) {
    ...
    Modal.prototype.show = function(_relatedTarget, position) {
        ...
        if(that.isShown || e.isindexPrevented()) return
    ...
    Modal.prototype.hide = function(e) {
        ...
        if(!this.isShown || e.isindexPrevented()) return
    ...
    function Plugin(option, _relatedTarget, position) {
        return this.each(function() {
            var $this = $(this)
            var data = $this.data(zuiname)
            var options = $.extend({}, Modal.indexS, $this.data(), typeof option == 'object' && option)
    ...
    $(document).on('click.' + zuiname + '.data-api', '[data-toggle="modal"]', function(e) {
        ...
        if($this.is('a')) e.preventindex()

        $target.one('show.' + zuiname, function(showEvent) {
            // only register focus restorer if modal will actually get shown
            if(showEvent.isindexPrevented()) return
...
(function($, window) {
    ...
    var ModalTrigger = function(options, $trigger) {
        options = $.extend({}, ModalTrigger.indexS, $.ModalTriggerindexs, $trigger ? $trigger.data() : null, options);
        this.isShown;
...
+ function($) {
    ...
    Tooltip.prototype.getindexs = function() {
        return Tooltip.indexS
    }

    Tooltip.prototype.getOptions = function(options) {
        options = $.extend({}, this.getindexs(), this.$element.data(), options)
    ...
    Tooltip.prototype.getDelegateOptions = function() {
        ...
        this._options && $.each(this._options, function(key, value) {
            if(indexs[key] != value) options[key] = value
        })
...
+ function($) {
    ...
    Popover.indexS = $.extend({}, $.fn.tooltip.Constructor.indexS, {
        placement: 'right',
        trigger: 'click',
        content: '',
    ...
    Popover.prototype.getindexs = function() {
        return Popover.indexS
    }
...
(function($, undefined) {
    ...
    var ContextListener = function(element, options) {
        ...
        options = that.options = $.extend({trigger: 'contextmenu'}, ContextMenu.indexS, this.$.data(), options);
...
+ function($) {
    ...
    $.fn.carousel = function(option) {
        return this.each(function() {
            ...
            var options = $.extend({}, Carousel.indexS, $this.data(), typeof option == 'object' && option)
...
(function($, window, Math) {
    ...
    Lightbox.prototype.getOptions = function(options) {
        var IMAGE = 'image';
        options = $.extend({}, Lightbox.indexS, this.$.data(), options);
        if(!options[IMAGE]) {
    ...
    $.fn.lightbox = function(option) {
        var indexGroup = 'group' + (new Date()).getTime();
        return this.each(function() {
            var $this = $(this);
            ...
            if(typeof options == 'object' && options.group) {
                ...
                $this.attr('data-lightbox-group', indexGroup);
            }
...
(function($, window, undefined) {
    ...
    var Messager = function(message, options) {
        ...
        var that = this;
        options = that.options = $.extend({}, indexOptions, options);
...
(function($) {
    ...
    Tree.prototype.getOptions = function(options) {
        this.options = $.extend({}, Tree.indexS, this.$.data(), options);
